...
<div class="container-fluid" >
      ...
      <h3 style="text-align: center">REPORTE DE EMPLEABILIDAD</h3>
      <div class="row">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Area', 'Egresados'],
          @foreach($empleabilidad as $reg)
              ['{{$reg->area}}',{{$reg->cantidadestudiantes}}],  
          @endforeach          
        ]);

        var options = {
          title: 'CANTIDAD DE EGRESADOS CON EXPERIENCIA DE EMPLEO EN UNA ÁREA',
          is3D: true,
        };

...
<div class="container-fluid" >
      ...
      <h3 style="text-align: center">REPORTE DE CALIDAD UNIVERSITARIA</h3>
      <div class="row">
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Carrera', 'Egresados'],
          @foreach($calidadUniversitaria as $reg)
              ['{{$reg->carrera}}',{{$reg->cantidadterciosuperior}}],  
          @endforeach          
        ]);

        var options = {
          title: 'CANTIDAD DE EGRESADOS EN TERCIO SUPERIOR POR CARRERA',
          is3D: true,
        };

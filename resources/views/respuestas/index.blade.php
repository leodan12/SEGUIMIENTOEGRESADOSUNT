...
<div class="container-fluid ">
  <div class="form-group">
    ...
    <div class="container">
      <h3 class="text-center">LISTADO DE RESPUESTAS DE ENCUESTAS</h3>
      <div class="d-none d-md-block col-12" style="position: relative;right: 40%">
        <button class=" btn btn-success" style="border-radius: 40px;"   type="menu"><a class="text-white" href="../../verencuestas" ><i class="fas fa-arrow-left"> </i> Regresar</a> </button>
      </div>
    ...
    <nav class="navbar navbar-light ">
      ...
      <div class="table-responsive"  style="border-radius: 12px;">
        ...
        <thead class="thead-dark">
          <tr>
            <th scope="col"style="text-align: center">EGRESADO</th>
              ...
              <th scope="col"style="text-align: center">{{$key->enunciado}}</th>
        ...
        @foreach($egresados as $ky)
            <tr>
                <th scope="col"style="text-align: center">{{$ky->nombres}} {{$ky->apellidos}}</th>
            
            @foreach($respuesta as $k)
                @if($ky->id==$k->id)
                <th scope="col"style="text-align: center">{{$k->enunciado}}</th> 
                @endif

...
<div class="container-fluid ">
  <div class="form-group">
    ...
    <nav class="navbar navbar-light ">
      <a href="{{route('ofertalaboral.create')}}" class="btn btn-success" style="border-radius: 40px;"><i class="fas fa-plus"></i>Registrar Oferta Laboral</a><br>
            ...
            @foreach($oferta as $k)
                <tr>
                    ...
                    <td class="menu" data-animation="to-left">  
                      <a href="{{route('ofertalaboral.edit',$k->id)}}"> 
                    ...
                    <td>
                      <div class="form-group" style="text-align: center">
                        <form class="submit-eliminar " action="{{action('OfertalaboralController@destroy', $k->id)}}" method="post">
                           @csrf
                           <input name="_method" type="hidden" value="DELETE">
                           <button onclick="return confirm('Desea cambiar el estado de la oferta?')" style="border-radius: 40px;" type="submit" class="btn btn-danger btn-sm">
